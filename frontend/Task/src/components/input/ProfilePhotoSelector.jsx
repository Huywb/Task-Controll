    ...
    <div className='flex justify-center mb-6'>
        ...
        {!image ? (
            <div className='w-20 h-20 flex items-center justify-center bg-blue-100/50 rounded-full relative cursor-pointer'>
                ...
                <button type='button' className='w-8 h-8 items-center flex justify-center bg-primary text-white rounded-full absolute -bottom-1 -right-1 cursor-pointer' onClick={onChooseFile}>
                    <LuUpload></LuUpload>
                </button>
            </div>
        ) : (
